...
from transformers import AutoConfig, AutoModelForCausalLM, get_scheduler, PreTrainedTokenizer
import torch
...
def setup_model(args, tokenizer: PreTrainedTokenizer, train_loader, grad_accum, flash_enabled):
    bnb_config = None
